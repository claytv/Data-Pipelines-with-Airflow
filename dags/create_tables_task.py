...
from helpers import create_tables_statements
...
drop_table_artists = PostgresOperator(
    ...
    sql=create_tables_statements.DROP_TABLE_ARTISTS,
    dag=dag
)
...
create_table_artists = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.CREATE_TABLE_ARTISTS, ## helper
    dag=dag
)
...
drop_table_songplays = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.DROP_TABLE_SONGPLAYS,
    dag=dag
)
...
create_table_songplays = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.CREATE_TABLE_SONGPLAYS,
    dag=dag
)
...
drop_table_songs = PostgresOperator(
    task_id='drop_songs',
    postgres_conn_id="redshift",
    sql=create_tables_statements.DROP_TABLE_SONGS,
    dag=dag
)
...
create_table_songs = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.CREATE_TABLE_SONGS,
    dag=dag
)
...
drop_table_staging_events = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.DROP_TABLE_STAGING_EVENTS,
    dag=dag
)
...
create_table_staging_events = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.CREATE_TABLE_STAGING_EVENTS,
    dag=dag
)
...
drop_table_staging_songs = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.DROP_TABLE_STAGING_SONGS,
    dag=dag
)
...
create_table_staging_songs = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.CREATE_TABLE_STAGING_SONGS,
    dag=dag
)
...
drop_table_time = PostgresOperator(
    task_id='drop_time',
    postgres_conn_id="redshift",
    sql=create_tables_statements.DROP_TABLE_TIME,
    dag=dag
)
...
create_table_time = PostgresOperator(
    task_id='create_time',
    postgres_conn_id="redshift",
    sql=create_tables_statements.CREATE_TABLE_TIME,
    dag=dag
)
...
drop_table_users = PostgresOperator(
    task_id='drop_users',
    postgres_conn_id="redshift",
    sql=create_tables_statements.DROP_TABLE_USERS,
    dag=dag
)
...
create_table_users = PostgresOperator(
    ...
    postgres_conn_id="redshift",
    sql=create_tables_statements.CREATE_TABLE_USERS,
    dag=dag
)
